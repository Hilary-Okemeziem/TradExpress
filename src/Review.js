    ...
    <div className='review-section pt-5 pb-5'>
        <div className='container'>
            ...
            <div className='row mt-5 pt-0 pt-lg-5'>
                <div className='col-lg position-relative text-center text-lg-start'>
                    <img src={img7} className='img-fluid' alt="" />
                    <div className=' review-text1'>
                        <img src={img8} className='img-fluid ms-3 review-quote' alt="" />
                    ...
                    <div className='d-inline-flex ms-4 mt-2 review-pics'>
                ...
                <div className='col-lg position-relative text-center text-lg-start mt-5 mt-lg-0 review-img2'>
                    <img src={img7} className='img-fluid' alt="" />
                    ...
                    <div className='d-inline-flex ms-4 mt-2 review-pics review-pics2'>
                        <img src={lhary} className='review-img' alt="" />
                        <div className='ms-2'>
                            <p><b>Bayo</b> <br />USA</p>    
                        </div>
                ...
                <div className='col-lg position-relative text-center text-lg-start mt-5 pt-2 pt-lg-0 mt-lg-0'>
                    <img src={img7} className='img-fluid' alt="" />
